        ...
        <div className="home-heading">
          ...
          <div className="home-title-container">
            ...
            <div className="home-title-desc popup-anim text--center">
              ...
              <br /> <br />
              A personalised diary to keep all types of notes you want.
            </div>
          </div>
        </div>
      </Fade>
        ...
        <div className="extra-features">
          <Fade triggerOnce>
            <div className="extra-features-content">
              ...
              Want to know how you feel throughout the week or so, we have your
              personalised statistics on display.
            </div>
            <div className="extra-features-content">
